const Form = () =>{
  ...
  <div class="container mx-auto px-5 py-24">
    ...
    <div class="mb-12 flex w-full flex-col text-center">
      <h1 class="title-font mb-4 text-4xl tracking-tight font-extrabold text-white sm:text-3xl">Get In Touch</h1>
      <p class="text-gray-300 sm:text-lg">We’d love to hear from you! Whether you have a question, suggestion, or story to share, please reach out to us.
      </p>
    </div>
      ...
      <div class="-m-2 flex flex-wrap">
        ...
        <div class="w-1/2 p-2">
          <div class="relative">
            ...
            <label for="name" class="absolute left-3 -top-6 bg-transparent text-sm leading-7 text-indigo-500 transition-all peer-placeholder-shown:left-3 peer-placeholder-shown:top-2  peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-focus:left-3 peer-focus:-top-6 peer-focus:text-sm peer-focus:text-indigo-500">Full Name</label>
          </div>
        </div>
        <div class="w-1/2 p-2">
          <div class="relative">
        ...
        <div class="mt-4 w-full p-2">
          <div class="relative">
            ...
            <label for="message" class="absolute left-3 -top-6 bg-transparent text-sm leading-7 text-indigo-500 transition-all peer-placeholder-shown:left-3 peer-placeholder-shown:top-2  peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-focus:left-3 peer-focus:-top-6 peer-focus:text-sm peer-focus:text-indigo-500">Message</label>
          </div>
        </div>
        ...
        <div class="mt-8 w-full border-t border-gray-800 p-2 pt-8 text-center">
          ...
          <p class="my-5 leading-normal">Mangilik el<br />Astana, Kazakhstan</p>
