...
const About = () => {
        ...
        <div className="2xl:container 2xl:mx-auto ">
            <div className="flex flex-col lg:flex-row justify-between gap-12 lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
                <div className="w-full lg:w-5/12 flex flex-col justify-center">
                    <h1 className="text-5xl font-bold text-[#A67F78] leading-tight pb-6">About Us</h1>
  ...
  <div className="max-w-7xl mx-auto px-4 lg:px-20 md:px-6">
                    ...
                    <h2 className="text-5xl font-bold text-gray-900 leading-tight pb-6 text-center">Our Work</h2>
                    ...
                    <div className="grid md:grid-cols-3 gap-8 mt-8">
                        <div className="p-6 bg-white shadow-md rounded-lg border-t-4 border-[#A67F78]">
                            <h3 className="text-xl font-semibold text-[#A67F78]">Story Collection</h3>
                        ...
                        <div className="p-6 bg-white shadow-md rounded-lg border-t-4 border-[#A67F78]">
                            <h3 className="text-xl font-semibold text-[#A67F78]">Promoting Achievements</h3>
                            <p className="text-gray-600 mt-2">
                        ...
                        <div className="p-6 bg-white shadow-md rounded-lg border-t-4 border-[#A67F78]">
                            <h3 className="text-xl font-semibold text-[#A67F78]">Exchange Platform</h3>
                            <p className="text-gray-600 mt-2">
                ...
                <div className="container mx-auto space-y-12">
                    <div className="flex flex-col overflow-hidden rounded-md lg:flex-row">
                        ...
                        <div className="flex flex-col justify-center flex-1 p-6">
                            <h3 className="text-3xl font-bold text-[#A67F78]">Success Stories</h3>
                    ...
                    <div className="flex flex-col overflow-hidden rounded-md lg:flex-row-reverse">
                        ...
                        <div className="flex flex-col justify-center flex-1 p-6">
                            <h3 className="text-3xl font-bold text-[#A67F78]">Technology and Science</h3>
                            <p className="my-6 text-gray-500">
                    ...
                    <div className="flex flex-col overflow-hidden rounded-md lg:flex-row">
                        ...
                        <div className="flex flex-col justify-center flex-1 p-6">
                            <h3 className="text-3xl font-bold text-[#A67F78]">Leadership and Public Activity</h3>
                            <p className="my-6 text-gray-500">
                                Women in Kazakhstan actively participate in the country's political life, occupy key positions in public movements and international organizations. Their leadership contributes to building a more just society and expanding women's rights and opportunities in all areas of life.
                            </p>
                        </div>
                    </div>
                </div>
