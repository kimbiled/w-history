const Form = () =>{
    return (
        <section class="body-font relative bg-gray-900 text-gray-300">

  <div class="container mx-auto px-5 py-24">
    
    <div class="mb-12 flex w-full flex-col text-center">
      <h1 class="title-font mb-4 text-2xl font-medium text-white sm:text-3xl">Связь</h1>
      <p class="mx-auto text-base leading-relaxed lg:w-2/3">Мы будем рады связаться с вами!<br />Если у вас есть вопрос, предложение или история, которой вы хотите поделиться, пожалуйста, свяжитесь с нами.
      </p>
    </div>
      ...
      <div class="-m-2 flex flex-wrap">
        ...
        <div class="w-1/2 p-2">
          <div class="relative">
            ...
            <label for="name" class="absolute left-3 -top-6 bg-transparent text-sm leading-7 text-indigo-500 transition-all peer-placeholder-shown:left-3 peer-placeholder-shown:top-2 peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-focus:left-3 peer-focus:-top-6 peer-focus:text-sm peer-focus:text-indigo-500">Фамилия Имя</label>
          </div>
        </div>
        <div class="w-1/2 p-2">
          <div class="relative">
        ...
        <div class="mt-4 w-full p-2">
          <div class="relative">
            <textarea id="message" name="message" class="peer h-32 w-full resize-none rounded-lg border border-gray-700 bg-gray-800 bg-opacity-40 py-1 px-3 text-base leading-6 text-gray-100 placeholder-transparent outline-none transition-colors duration-200 ease-in-out focus:border-indigo-500 focus:bg-gray-900 focus:ring-2 focus:ring-indigo-900" placeholder="Ваше предложение . . ."></textarea>
            <label for="message" class="absolute left-3 -top-6 bg-transparent text-sm leading-7 text-indigo-500 transition-all peer-placeholder-shown:left-3 peer-placeholder-shown:top-2 peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-focus:left-3 peer-focus:-top-6 peer-focus:text-sm peer-focus:text-indigo-500">Ваше предложение</label>
          </div>
        </div>
        ...
        <div class="mt-8 w-full border-t border-gray-800 p-2 pt-8 text-center">
          ...
          <p class="my-5 leading-normal">Мангилик ел <br />Астана, Казахстан</p>
