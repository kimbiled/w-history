        ...
        <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
            <div className="flex flex-col lg:flex-row justify-between gap-12">
                <div className="w-full lg:w-5/12 flex flex-col justify-center">
                    <h1 className="text-5xl font-bold text-gray-900 leading-tight pb-6">О Нас</h1>
            ...
            <h2 className="text-5xl font-bold text-gray-900 leading-tight pb-6">Наша работа</h2>
                ...
                <div className="grid md:grid-cols-3 gap-8 mt-8">
                    <div className="p-6 bg-white shadow-md rounded-lg border-t-4 border-[#A67F78]">
                        <h3 className="text-xl font-semibold text-gray-900">Сбор историй</h3>
                    ...
                    <div className="p-6 bg-white shadow-md rounded-lg border-t-4 border-[#A67F78]">
                        <h3 className="text-xl font-semibold text-gray-900">Популяризация достижений</h3>
                    ...
                    <div className="p-6 bg-white shadow-md rounded-lg border-t-4 border-[#A67F78]">
                        <h3 className="text-xl font-semibold text-gray-900">Платформа для обмена</h3>
                ...
                <div className="container mx-auto space-y-12">
                    <div className="flex flex-col overflow-hidden rounded-md lg:flex-row">
                        ...
                        <div className="flex flex-col justify-center flex-1 p-6">
                            <h3 className="text-3xl font-bold">Истории успеха</h3>
                    ...
                    <div className="flex flex-col overflow-hidden rounded-md lg:flex-row-reverse">
                        ...
                        <div className="flex flex-col justify-center flex-1 p-6">
                            <h3 className="text-3xl font-bold">Технологии и наука</h3>
                    ...
                    <div className="flex flex-col overflow-hidden rounded-md lg:flex-row">
                        ...
                        <div className="flex flex-col justify-center flex-1 p-6">
                            <h3 className="text-3xl font-bold">Лидерство и общественная деятельность</h3>
