...
const About = () => {
        ...
        <div className="2xl:container 2xl:mx-auto">
            <div className="flex flex-col lg:flex-row justify-between gap-12 lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
                <div className="w-full lg:w-5/12 flex flex-col justify-center">
                    <h1 className="text-5xl font-bold text-[#A67F78] leading-tight pb-6">Біз туралы</h1>
            ...
            <h2 className="text-5xl font-bold text-[#A67F78] leading-tight pb-6 text-center ">Біздің жұмысымыз</h2>
                ...
                <div className="grid md:grid-cols-3 gap-8 mt-8">
                    <div className="p-6 bg-white shadow-md rounded-lg border-t-4 border-[#A67F78]">
                        <h3 className="text-xl font-semibold text-[#A67F78]">Тарихтарды жинау</h3>
                    ...
                    <div className="p-6 bg-white shadow-md rounded-lg border-t-4 border-[#A67F78]">
                        <h3 className="text-xl font-semibold text-[#A67F78]">Жетістіктерді насихаттау</h3>
                    ...
                    <div className="p-6 bg-white shadow-md rounded-lg border-t-4 border-[#A67F78]">
                        <h3 className="text-xl font-semibold text-[#A67F78]">Тәжірибе алмасу платформасы</h3>
                ...
                <div className="container mx-auto space-y-12">
                    <div className="flex flex-col overflow-hidden rounded-md lg:flex-row">
                        ...
                        <div className="flex flex-col justify-center flex-1 p-6">
                            <h3 className="text-3xl font-bold text-[#A67F78]">Табыс тарихтары</h3>
                    ...
                    <div className="flex flex-col overflow-hidden rounded-md lg:flex-row-reverse">
                        ...
                        <div className="flex flex-col justify-center flex-1 p-6">
                            <h3 className="text-3xl font-bold text-[#A67F78]">Технология және ғылым</h3>
    ...
    <div className="flex flex-col justify-center flex-1 p-6">
        <h3 className="text-3xl font-bold text-[#A67F78]">Көшбасшылық және қоғамдық қызмет</h3>
